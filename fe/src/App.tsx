...
function App() {
    ...
    return (
        <>
            ...
            {/* Snowflakes - Small, gentle snowfall effect */}
                ...
                {[...Array(50)].map((_, index) => (
                    <div
                        ...
                        style={{
                            ...
                            animationDuration: `${Math.random() * 5 + 5}s`, // Slow falling animation
                            animationDelay: `${Math.random() * 2}s`, // Random delay before falling starts
                            opacity: `${Math.random() * 0.5 + 0.5}`, // Slight opacity for a subtle effect
                            width: `${Math.random() * 3 + 2}px`, // Small snowflakes
                            height: `${Math.random() * 3 + 2}px`, // Small snowflakes
                        }}
                    ></div>
                ))}
            </div>
