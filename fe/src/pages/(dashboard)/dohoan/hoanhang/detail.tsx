                                                ...
                                                <tr key={index} className="hover:bg-gray-50">
                                                    <td className="p-4">
                                                        <div className="flex gap-4">
                                                            <img
                                                                src={item?.bien_the_san_pham?.san_pham?.anh_san_pham}
                                                                alt=""
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="text-sm text-gray-600 space-y-1">
                                                                    <p>Màu: {item?.bien_the_san_pham?.mau_bien_the?.ten_mau_sac}</p>
                                                                    <p>Size: {item?.bien_the_san_pham?.kich_thuoc_bien_the?.kich_thuoc}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td className="p-8">{item?.so_luong}</td>
                                                    <td className="p-6">{item?.gia?.toLocaleString('vi-VN')}đ</td>
                                                    <td className="p-6 font-medium">{item?.thanh_tien?.toLocaleString('vi-VN')}đ</td>
                                                </tr>
                                            ))}
                                        </tbody>
                                    </table>
                            ...
                            <div className="bg-white rounded-lg shadow-sm border mt-6 p-4">
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="font-medium">{data?.data?.tong_tien_san_pham?.toLocaleString('vi-VN')}đ</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-lg font-bold text-blue-600">
                                            {(data?.data?.tong_tien_san_pham + 20000)?.toLocaleString('vi-VN')}đ
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-lg shadow-sm border p-4">
                                ...
                                <div className="space-y-3">
                                    <div>
                                        ...
                                        <p className="font-medium">{orderInfo?.ten_nguoi_dat_hang}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-600 mb-1">Số điện thoại</p>
                                        <p className="font-medium">{orderInfo?.so_dien_thoai_nguoi_dat_hang}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-600 mb-1">Địa chỉ</p>
                                        <p className="font-medium">{orderInfo?.dia_chi_nguoi_dat_hang}</p>
                                    </div>
                                    <div>
