...
//     if (!tenSize) {
//       message.error("Vui lòng nhập tên kích thước");
//       return;
//     }

//     addSizeMutation.mutate({ kich_thuoc: tenSize });
//   };
...
//             </Button>
//           </Popconfirm>
//           <Link to={`/admin/products/bienthe/edit/${item.id}`}>
...
//       <Form form={form} onFinish={onFinish}  className="mt-4 flex space-x-2">
