...
const Detail: React.FC<ProductDetailProps> = ({ item }: any) => {
  ...
  const getStockStatus = (variant: ProductVariant) => {
    if (variant.so_luong_bien_the > 0) {
      ...
      return (
        <span style={{ fontSize: "16px", fontWeight: "bold" }}>Hết hàng</span>
      );
    }
  };
                  ...
                  <div className="product_detail_name">
                    ...
                    <div className="mb-3">
                      ...
                      {product.bo_suu_tap_san_pham.map((tag) => (
                        <span
                          key={tag.id}
                          className="bg-blue-100 px-2 py-1 rounded-md text-xs font-bold text-blue-700 mr-2 "
                        >
                          {tag.ten}
                        </span>
                      ))}
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              setSelectedColorName(
                                colorVariant?.mau_bien_the.ten_mau_sac || null
                              );
                            }}
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        <path
                          ...
                          stroke-linejoin="round"
                          stroke-width="2"
                          d="M8 7V3M8 21v-6m8-6v6m0 0v6m-8-6h8"
                        />
                      </svg>
                      <span className="text-gray-700 font-medium">
                        Giao hàng:
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        <path
                          ...
                          stroke-linejoin="round"
                          stroke-width="2"
                          d="M19 7v7a2 2 0 002 2h2V7h-2a2 2 0 00-2-2H5a2 2 0 00-2 2v7a2 2 0 002 2h2V7H5z"
                        />
                      </svg>
                      <span className="text-gray-700 font-medium">
                        Miễn phí đổi trả:
