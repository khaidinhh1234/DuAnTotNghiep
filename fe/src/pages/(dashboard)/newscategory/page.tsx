...
const NewCategory = () => {
  ...
  const dataSource = data?.data.map((newcategory: NewCategories) => ({
    key: newcategory.id,
    ...newcategory,
  })) || [];
  const { mutate } = useMutation({
    ...
    onSuccess: (id) => {
        queryClient.invalidateQueries(['danhmuctintuc']);
  ...
  const columns: TableColumnsType<NewCategories> = [
    ...
    },
    {
      ...
      sorter: (a: any, b: any) => a.ten_danh_muc_tin_tuc.localeCompare(b.ten_danh_muc_tin_tuc),
