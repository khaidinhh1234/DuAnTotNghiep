...
const PageTransport = () => {
  ...
  const renderCard = (title : any, number: any, amount: any, color = 'black', highlight = false) => (
    <Card bordered={false} style={{ backgroundColor: highlight ? '#fff5f5' : '#f5f5f5' }}>
    ...
    <div style={{ padding: 20 }}>
      ...
      <div style={{ marginTop: 20 }}>
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col span={8}>
            {renderCard('Đơn chưa xác thực', '0', '0')}
          </Col>
          <Col span={8}>
            {renderCard('Chờ thanh toán', '1', '1,300,000')}
          </Col>
          <Col span={8}>
            {renderCard('Chưa giao hàng', '2', '1,526,000')}
          </Col>
        </Row>
        ...
        <Row gutter={[16, 16]} style={{ marginTop: 20 }}>
          ...
          <Col span={8}>
            {renderCard('Chờ lấy hàng', '0', '0')}
          </Col>
          <Col span={8}>
            {renderCard('Đang giao hàng', '0', '0')}
          </Col>
          <Col span={8}>
            {renderCard('Không gặp khách', '0 đơn', '0',)}
          </Col>
        </Row>
        ...
        <Row gutter={[16, 16]} style={{ marginTop: 20 }}>
          ...
          <Col span={8}>
            {renderCard('Chờ chuyển hoàn', '0', '0')}
          </Col>
          <Col span={8}>
            {renderCard('Đã chuyển hoàn, chưa nhập kho', '0', '0')}
          </Col>
        </Row>
      </div>
    </div>
