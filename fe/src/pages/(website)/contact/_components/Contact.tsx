    ...
    <>
      <main className="py-10">
        <div className="container my-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-4 md:mx-14">
            ...
            <div className="col-span-1 md:col-span-1">
              ...
              <div className="bg-gray-100 py-5 px-12 rounded-lg w-full md:w-[700px] mx-auto">
              ...
              <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
                <div className="flex flex-col space-y-2">
                  ...
                  <input
                    ...
                    className={`border rounded-lg px-3 py-2 w-full ${errors.name ? "border-red-600" : "border-stone-500"
                      }`}
                  />
                  {errors.name && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="flex flex-col space-y-2">
                    ...
                    <input
                      ...
                      className={`border rounded-lg px-3 py-2 w-full ${errors.email ? "border-red-600" : "border-stone-500"
                        }`}
                    />
                    {errors.email && (
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <select
                      ...
                      className="border border-stone-500 rounded-lg px-3 py-2 w-full"
                    >
                      <option value="ho_tro">Hỗ trợ</option>
                      <option value="bao_gia">Báo giá</option>
                      <option value="phan_hoi">Phản hồi</option>
                      <option value="thong_bao_san_pham_moi">Thông báo sản phẩm mới</option>
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <textarea
                    ...
                    className={`border rounded-lg px-3 py-2 w-full ${errors.noi_dung_lien_he
                        ? "border-red-600"
                        : "border-stone-500"
                      }`}
                  />
                ...
                <button
                  onClick={handleCart}
                  type="submit"
                  className={`btn-black lg:text-lg lg:py-2 lg:px-7 py-2 px-5 font-medium rounded-lg w-full ${isPending
                      ? "cursor-not-allowed"
                      : "hover:bg-black hover:text-white"
                    }`}
                >
                  <span>{isPending ? "Đang gửi..." : "Gửi yêu cầu hỗ trợ"}</span>
                </button>
                <Modal
