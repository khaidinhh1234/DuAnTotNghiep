    ...
    <div className="grid grid-cols-12 gap-6">
      <div className="col-span-12">
        ...
        <p className="text-sm lg:text-lg mb-5 text-center">
          Chúng tôi ở đây để giúp bạn. Nếu bạn có bất kỳ câu hỏi nào hoặc cần
          trợ giúp, vui lòng liên hệ với chúng tôi.
        </p>
        <div className="lg:col-span-6 col-span-12 mx-auto">
          <div className="bg-gray-100 py-5 px-5 lg:px-12 rounded-lg max-w-full lg:max-w-3xl mx-auto">
            ...
            <div className="flex items-center space-x-3 py-1">
              ...
              <span className="text-sm lg:text-lg">{websiteInfo?.email}</span>
            </div>
            <div className="flex items-center space-x-3 py-1">
              <i className="fa-regular fa-location-dot text-lg" />
              <span className="text-sm lg:text-lg">{websiteInfo?.dia_chi}</span>
            </div>
          </div>
        </div>
        ...
        <form className="space-y-5 mt-8" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="flex flex-col space-y-2">
              <label htmlFor="loai_lien_he" className="text-sm lg:text-lg">
                Loại Liên Hệ
              </label>
              <select
          ...
          <div className="flex flex-col space-y-2">
            <label htmlFor="noi_dung_lien_he" className="text-sm lg:text-lg">
              Tin Nhắn
            </label>
            <textarea
