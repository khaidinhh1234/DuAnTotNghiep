    ...
    <section>
        ...
        <div className="container mb-28">
          <div className="flex justify-center mb-5">
            <h1 className="text-4xl font-medium tracking-[1px]">Our Bestseller</h1>
          </div>
            ...
            >
              <div className="product-card hover:bg-zinc-100">
                <div className="w-full h-[400px] relative">
                  <a href="#"
                    ><i
                      className="fa-regular fa-star text-lg bg-white px-[13px] py-[14px] rounded-full absolute top-5 right-6 btn invisible opacity-0 transition-opacity duration-300"
                    ></i
                  ></a>
                  <a href="#"
                    ><i
                      className="fa-solid fa-arrow-right-arrow-left text-lg bg-white px-4 py-[14px] rounded-full absolute top-[70px] right-6 btn invisible opacity-0 transition-opacity duration-300"
                    ></i
                  ></a>
                  <a href="#"
                    ><i
                      className="fa-regular fa-eye text-lg bg-white px-[13px] py-[14px] rounded-full absolute top-[121px] right-6 btn invisible opacity-0 transition-opacity duration-300"
                    ></i
                  ></a>
                  <img
                    src={sanPham2}
