...
const ProductList = ({ products, sectionTitle, isPromotional = false }) => {
      ...
      <section>
        <div className="container mb-28">
          <div className="flex justify-center mb-5">
            <h1 className="md:text-4xl text-3xl font-semibold tracking-[1px]">{sectionTitle}</h1>
          </div>
          ...
          <div className="grid grid-cols-12 justify-center gap-7">
            {products?.slice(0, visibleProductsCount).map((product: any, index: any) => {
              ...
              return (
                  <div className="xl:col-span-3 lg:col-span-4 col-span-12 md:col-span-6 mb-2 lg:w-[300px] w-[350px] mx-auto lg:mx-0" key={index}>
                      ...
                      <div className="bg-slate-50 pt-4 px-4 rounded-md pb-2">
                        ...
                        <p className="font-bold text-lg flex items-center">
                          {product?.mau_sac_va_anh?.map((item: any, indexs: any) => (
                              <button
                                  key={indexs}
                                  className={`w-7 h-7 rounded-full border mr-1 ${hoveredProductId === product?.id && hoveredVariantIndex === indexs
                                      ? "border-black"
