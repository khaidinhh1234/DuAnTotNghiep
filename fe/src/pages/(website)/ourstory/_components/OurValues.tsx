    ...
    <section id="OurValues" className="mt-16">
        <div className="container">
          ...
          <div className="grid grid-cols-12 bg-[#D0DBE1]">
            ...
            <div
              className="col-span-6 flex flex-col justify-center items-center text-center"
            >
              <h3 className="mb-4 font-bold text-2xl lg:text-4xl text-[#6A747A]">
                Integrity
              </h3>
              <p className="lg:w-96 mx-auto text-[#7b8799] text-sm">
                We always prioritize integrity and ethics in all activities.
                Every transaction and product at Krist is transparent and
                trustworthy.
              </p>
            </div>
            <div
              className="col-span-6 flex flex-col justify-center items-center text-center bg-[#D3D4D0]"
            >
              ...
              <p className="lg:w-96 mx-auto text-[#7b8799] text-sm">
                ...
                high-quality materials and undergoes meticulous testing to
            ...
            >
              ...
              <p className="lg:w-96 mx-auto text-[#7b8799] text-sm">
                ...
                fashion products to our customers. Creativity drives us to
                develop and improve every day.
              </p>
            </div>
          </div>
        </div>
