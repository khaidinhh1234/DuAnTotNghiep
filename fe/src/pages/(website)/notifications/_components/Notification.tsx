                        ...
                        <div className="grid lg:grid-cols-12 grid-cols-8 lg:gap-8 gap-2 lg:my-12 my-6">
                            ...
                            <div className="lg:col-span-9  col-span-8 lg:pl-5">
                                ...
                                <div className="flex justify-between items-end border-b border-hrBlack pb-5 mb-5">
                                    <div className="flex">
                                        <img src={ellipse} alt className="w-14 h-14 rounded-full" />
                                        <div className="px-4">
                                            <h4 className="font-bold text-base mb-2">Profile Update</h4>
                                            <p className="text-[#A4A1AA]">Your order placed successfullty</p>
                                        </div>
                                    </div>
                                ...
                                <div className="flex justify-between items-end border-b border-hrBlack pb-5 mb-5">
                                    <div className="flex items-center">
                                        ...
                                        <div className="px-4">
                                            <h4 className="font-bold text-base mb-2">Your order placed successfullty</h4>
