...
//   const VoucherDetail = ({ isOpen, onClose, voucher }: VoucherDetailProps) => {
...
//           <h2 className="text-3xl font-bold mb-6 text-gray-800">Chi tiết mã ưu đãi</h2>
...
//                 {voucher.ma_code}
//                 </div>
//                 <div className="flex flex-col sm:flex-row sm:items-center gap-[15px] mt-2">
//                   <p className="text-red-500 text-sm">
//                     HSD: {new Date(voucher.ngay_ket_thuc).toLocaleDateString()}
//                   </p>
//                   <a href="#" className="text-gray-700 text-sm font-medium">Điều kiện</a>
//                 </div>
//               </div>
  
//               <div className="flex-shrink-0">
//               <button        
//  className="bg-[#63b1bc] text-white font-semibold py-2 px-8 rounded whitespace-nowrap">                  Lưu mã
//                 </button>
//               </div>
//             </div>
//           </div>
...
//               <li>- Hạn sử dụng: {new Date(voucher.ngay_bat_dau).toLocaleDateString()} - {new Date(voucher.ngay_ket_thuc).toLocaleDateString()}</li>
//               <li>-     ưu đãi:{voucher.mo_ta}</li>
//               <li>- {voucher.ap_dung}</li>
//               <li>- Đơn tối thiểu {voucher.chi_tieu_toi_thieu.toLocaleString()}đ</li>
...
//           <button 
//             onClick={onClose}
//             className="bg-black text-white py-2 px-40 mt-8 block mx-auto text-lg font-semibold"
//           >
//             Lưu mã
//           </button>
//         </div>
...
const VoucherDetail = ({ isOpen, onClose, voucher, onSave, isSaved }: VoucherDetailProps) => {
        ...
        <div className="mb-8">
          <div className="flex items-center bg-white border border-gray-200 rounded-lg p-4 shadow-md w-full max-w-[450px] min-h-[150px] relative">
            ...
            <div className="flex-grow">
              ...
              {voucher.loai === 'tien_mat' 
                  ? `Giảm ${voucher.giam_gia.toLocaleString()}đ`
                  : `Giảm ${voucher.giam_gia}%`} cho đơn từ {voucher.chi_tieu_toi_thieu.toLocaleString()}đ
              </p>
              <div className="bg-[#cfebee] text-[#63b1bc] px-2 py-1 rounded mt-2 inline-block">
                {voucher.ma_code}
              </div>
