    ...
    const Test123 = () => {
      ...
      return (
        ...
        <div className="flex items-center space-x-4 ml-32">
            ...
            {/* Navigation Links */}
                <nav className="flex space-x-6 text-gray-700 font-bold ml-4 relative z-30">  {/* Đảm bảo header có z-index cao */}
                    ...
                    <div
                        ...
                        className="relative"
                    >
                        <a href="#" className="hover:text-blue-500">Nam</a>
                        <Drawer
                            placement="top"
                            height={200}
                    ...
                    <div
                        ...
                        className="relative"
                    >
                        <a href="#" className="hover:text-blue-500">Nữ</a>
                        <Drawer
                            placement="top"
                            height={200}
                            onClose={handleMouseLeave}
                    ...
                    <div
                        ...
                        className="relative"
                    >
                        <a href="#" className="hover:text-blue-500">Trẻ em</a>
                        <Drawer
                            placement="top"
                            height={200}
                            onClose={handleMouseLeave}
