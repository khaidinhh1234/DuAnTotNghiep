...
const Notifications: React.FC<NotificationsProps> = ({
  ...
  return (
    <div className="relative w-96 -right-3 -top-5  pt-6">
      <div className="bg-white rounded-lg shadow-xl border border-gray-200">
        <div className="absolute top-4 right-1 transform -translate-x-1/2 w-0 h-0 border-l-8 border-r-8 border-b-8 border-transparent border-b-stone-500"></div>
