            ...
            ? items.danh_muc.map((category: any) => ({
                ...
                label: (
                    <div className="menu-item py-5 flex flex-col gap-y-2 items-start !m-0 !p-0 !mx-28 !gap-x-20 ">
                        <a className="row text-black text-base font-bold" href={`/${category.duong_dan}`} rel="noopener noreferrer">
                        ...
                        >
                            <Dropdown
                                menu={{
                                    ...
                                    className: "custom-dropdown flex flex-row justify-start top-[40px]  ",
                                }}
                                // overlayStyle={{ width: '100vw' , overflow: 'hidden' }} 
                            >
                                <Link to="#" className="text-black">{item.label}</Link>
                            </Dropdown>
                        </div>
                    ))}
