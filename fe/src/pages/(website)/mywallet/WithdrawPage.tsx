...
const WithdrawPage = () => {
  ...
  const { bankData } = location.state as {
    bankData: WithdrawPageProps["bankData"];
  };
  ...
  const withdrawalMutation = useMutation({
    mutationFn: (withdrawalData: { so_tien: number; ma_xac_minh: string }) =>
      instanceClient
        .post(`/rut-tien/${bankData.id}`, withdrawalData)
        .then((res) => res.data),
    onSuccess: () => {
      ...
      <div className="w-full h-full">
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <span className="absolute top-1/2 transform -translate-y-1/2 left-3 text-gray-400 text-2xl">
              ₫
            </span>
            <input
              type="number"
        ...
        <div className="text-gray-500 text-sm mb-6">
          ...
          {"           Số tiền rút tối thiểu là 50.0000đ  "}
          ...
          <div className="bg-white rounded-lg p-6 w-96">
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                disabled={
                  pins.some((pin) => !pin) || withdrawalMutation.isPending
                }
