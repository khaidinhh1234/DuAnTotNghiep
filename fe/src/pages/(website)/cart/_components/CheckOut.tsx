        ...
        <div className="grid lg:grid-cols-12 gap-4 px-0 justify-center">
                ...
                <tr className="*:py-8">
                  <td>
                    <div className="flex gap-5 px-2 xl:w-[352px] sm:w-[392px] md:w-[309px]">
                      <img src={products1} alt= "" className="w-12 h-12" />
                      <div className="px-1">
                        ...
                        <div className="lg:hidden flex mt-2">
                          ...
                          <input type="number" id="numberInput" defaultValue={1} className="w-9 h-7 border-y focus:ring-0 focus:outline-none text-center border-blackL" />
                  ...
                  <td className="hidden lg:block">
                    <div className="border rounded-lg border-black xl:mx-5">
                      ...
                      <input type="number" id="numberInput" defaultValue={1} className="w-9 h-10 border-0 focus:ring-0 focus:outline-none text-center" />
          ...
          <div className="lg:col-span-4 col-span-6">
            <div className="border px-4 py-1 lg:w-[359px] rounded-md">
              ...
              <div className="py-4">
                <label className="text-xs">Enter Discount Code</label><br />
                <div className="flex">
                  <input type="text" placeholder="FLAT50" className="lg:w-[218px] w-[300px] h-[56px] px-4 rounded-s-lg focus:outline-none border border-l-2 border-t-2 border-blackL border-r-0" />
              ...
              <div className="flex justify-center">
                <a href="shippingaddress.html"><button className="btn-black rounded-lg mb-4 w-[320px] h-[56px]">
                  Proceed to Checkout
                </button></a>
              </div>
            </div>
