...
const PasswordChangedSuccess = () => {
  return (
    <div className="relative bg-white p-8 rounded-lg shadow-lg mx-auto max-w-md text-center">
      ...
      <h2 className="text-2xl font-bold text-center mb-2">Password Changed Successfully</h2>
      <p className="text-gray-600 text-center mb-6">Your password has been updated successfully</p>
      <Link to="/login" className="w-full bg-gray-900 text-white py-2 rounded-md hover:bg-gray-800 transition duration-300 block text-center">
        Back to Login
      </Link>
    </div>
  );
